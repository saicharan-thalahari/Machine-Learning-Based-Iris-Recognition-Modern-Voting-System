...
main = tkinter.Tk()
main.title("Machine Learning based Iris Recognition Modern Voting System") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Machine Learning based Iris Recognition Modern Voting System')
